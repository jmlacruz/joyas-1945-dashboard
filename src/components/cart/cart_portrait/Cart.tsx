...
function Cart() {
    ...
    return (                                                                                                    /* Tabla de productos en carrito */
        <div className="pagesContainer cartPageContainer cartPageContainer_portrait flex column">
            <div className="cartContainer flex column">
                ...
                <div className="cart-container cart-container_ortrait">
                    {cartProductsRows}
                </div>

                <div className="cartPortrait_noteCont">
                    <div className="cartPortrait_note flex column" ref={observation1ContRef}>
                        ...
                        <div className="cartTableLandsCapeGeneralObservation_buttons_cont flex column">
                            {
                                ...
                                <button className="customButton1 cartPortrait_noteButton mb050" onClick={handleObservation1AddText}>AGREGAR OBSERVACIÓN GENERAL DEL PEDIDO
                                </button>
                            }
                            {
                                observation1Editing &&
                ...
                <div className="cartPage_firstLineButtons flex column">                                                         {/* Opciones de método de envío y forma de pago */}
                    <Link to="/home" className="cartTablePortrait_buttonCont">
                        <button className="customButton1 cartTablePortrait_button flex">SEGUIR COMPRANDO</button>
                    </Link>
                    <Select1 options={shippingMethodsNames || []} defaulOption={selectedShippingMethodName} selectResultFunc={shippingMethodSelectFunc} class="cartPagePortrait_select"/>
                </div>
                <Select1 options={options2} defaulOption={selectedPaymentMethodName} class="selectStyle cartPagePortrait_select" selectResultFunc={paymentMethodSelectFunc}/>
                ...
                {   showTransferOrDepositOptions &&                                                                      /* Tabla que aparece cuando se selecciona "Transferencia o deposito bancario" */       
                    <>
                            ...
                            <table className="cart-table">
                                <tbody>
                                    <tr className="cart-table_finalRow">
                                        <td colSpan={4}>
                                            <div className="cartTable_flexDivCell cartTable_total cartTable_totalPortrait flex column">
                                                <p className="cartTable_total_text1">Total con descuento</p>
                                                <div className="flex">
                                                    ...
                                                    <span className="cartTable2_pricesSeparator">/</span>
                                                    <p className="cartTable2_prices_texts cartTable2_discount2">{dolar ? (parseFloat(total) * 1.21 * 0.9).toFixed(2) : Math.ceil(parseFloat(total) * 1.21 * 0.9)}</p>
                                                </div>
                                                <p className="cartTable2_finalTexts cartTable2_prices_finalText">Si abonas ahora, obtenés un 10% de descuento</p>
                                            </div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div className="cartTable_buyerTypeCont flex column">
                            <Select1 options={options3} class="cartPagePortrait_select" defaulOption={selectedBuyerTypeName} selectResultFunc={buyerTypeSelectFunc} />
                            <div className="cartPortrait_fiscalDataInputsCont flex">
                ...
                <div className={`cartPage_finalizePurchaseButton cartPagePortrait_finalizePurchaseButton flex ${isProcessingPurchase ? "disabled" : ""}`} onClick={isProcessingPurchase ? undefined : finalizePurchase}>
