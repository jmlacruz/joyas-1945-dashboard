...
const Button1 = forwardRef<HTMLButtonElement, IButtonProps>((props, ref) => {
    const {
        borderWidth,
        children,
        className,
    ...
    const btnVariants: { [key in TButtonVariants]: string } = {
        solid: classNames(
            ...
            [
                `${borderWidth as TBorderWidth} border-${color as TColors}-${colorIntensity as TColorIntensity
                }`,
            ],
            [`${textColor}`],
            // Hover
        ...
        default: classNames(
            ...
            // Hover
            [
                `hover:text-${color as TColors}-${colorIntensity as TColorIntensity
