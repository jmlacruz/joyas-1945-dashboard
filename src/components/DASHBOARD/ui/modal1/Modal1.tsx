...
export const ModalHeader: FC<IModalHeaderProps> = (props) => {
	...
	const classes = classNames(
		'flex items-center justify-between px-4 pb-4 text-2xl font-semibold [&:first-child]:pt-4 dashBoard_modal1Header',
	);
...
const Content: FC<IContentProps> = (props) => {
	...
	const classes = classNames(
		'pointer-events-auto relative flex w-full flex-col bg-white dark:bg-zinc-950 dashBoard_modal1Cont',
		'shadow-2xl',
		[`${rounded as TRounded}`],
		{
...
const Modal1: FC<IModalProps> = (props) => {
	const {
		children,
		isOpen,
		setIsOpen,
